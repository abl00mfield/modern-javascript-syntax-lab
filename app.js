...
const numTimesTwo = nums.map((element) => {
  return element * 2;
});
...
console.log("second ingreient: ", secondIngredient);
...
userProfile[propertyName] = "abl00m";
...
const localLangConfig = "sp"; // Change to 'es', 'fr', etc., or leave it `null`.
